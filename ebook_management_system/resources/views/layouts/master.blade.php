            ...
            <section class="ft-left sidenav">
                <ul class="menu">
                    ...
                    <li
                        ...
                        request()->is('category/update/*') ||
                        request()->is('category/edit/*') ||
                        request()->is('category/delete/*') ||
                        request()->is('category/create')
                            ? 'active'
                            : null }}">
                    ...
                    <li
                        class="{{ request()->is('borrows') || request()->is('borrows/create') || request()->is('borrows/*') ? 'active' : null }}">
