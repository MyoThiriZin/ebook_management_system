...
<div class="add-btn clearfix">
  <a href="{{ route('authors.create') }}" class="ft-right"><button class="add-btn-link"><i class="fa-fw fas fa-plus"></i> Add Author</button></a><br class="sp">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="action">
        ...
        <button class="delete-btn" data-bs-toggle="modal" data-bs-target="#modal{{ $author->id }}"><i class="fa-solid fa-trash-can"></i></button>
      </td>
