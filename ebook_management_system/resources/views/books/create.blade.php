    ...
    <form action="{{url('/books')}}" method="POST" enctype="multipart/form-data" class="clearfix form">
      ...
      <div class="clearfix">
        <div class="col">
          ...
          <input type="text" name="name" class="name" placeholder="Name" value="{{old('name')}}">
          @if ($errors->has('name'))
        ...
        <div class="col">
          ...
          <input type="number" name="duration" class="duration" placeholder="Duration" value="{{old('duration')}}">
    ...
    <div class="clearfix">
        <div class="col">
          ...
          <select name="author_id" class="author">
              ...
              @foreach ($authors as $key => $value)
                  <option {{ old('author_id') == $key ? "selected" : "" }} value="{{ $key }}">{{ $value }}</option>
              @endforeach
          </select>
        ...
        <div class="col">
          ...
          <select name="category_id" class="category">
              ...
              @foreach ($categories as $key => $value)
                  <option {{ old('category_id') == $key ? "selected" : "" }} value="{{ $key }}">{{ $value }}</option>
              @endforeach
          </select>
      ...
      <div class="clearfix">
        <div class="col">
          ...
          <textarea name="description" class="description" placeholder="Description" cols="30" rows="5">{{ old('description') }}</textarea>
