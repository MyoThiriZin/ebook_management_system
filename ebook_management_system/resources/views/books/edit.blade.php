  ...
  <form action="{{ route('books.update', $item->id) }}" method="POST" enctype="multipart/form-data" class="form">
    ...
    <div class="clearfix">
      ...
      <div class="col">
        ...
        <input type="number" name="duration" class="duration" placeholder="Duration" value="{{ old('duration', $item->duration) }}">
    ...
    <div class="clearfix">
      <div class="col">
        ...
        <input type="file" accept="image/gif, image/jpeg, image/png" name="image" class="myfile" placeholder="Book Image" value="{{ $item->image }}">
      </div>
    ...
    <div class="clearfix">
      <div class="">
        ...
        <textarea name="description" class="book-des" placeholder="Description" cols="30" rows="5">{{ old('description', $item->description) }}</textarea>
    ...
    <input type="button" value="Cancel" class="back-btn ft-right me-3" onclick="window.location='{{ URL::to('books') }}'" />
  </form>
</div>
@endsection